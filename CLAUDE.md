...
```
assets/
  sprites/     — 96×96 PNG battle sprites (downloaded from DCSS via tools/gen_sprites_v3.py, CC0)
  portraits/   — 200×190 PNG class portraits for ClassSelect (generated by same script)

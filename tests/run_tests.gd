...
func _run_all() -> void:
	...
	_run_suite("Run38 (MilestonePerks+LifetimeBosses)", TestRun38.new())
	...
	_run_suite("Run49 (RegeneratingStatus+IronResolve)", TestRun49.new())
	_run_suite("Run50 (UnitHoverTooltip)", TestRun50.new())
